<x-app-layout :title="'Data Program Motor Lunas'">
    <div class="container mt-4">
        <h3 class="text-center">Program Mobil Data "LUNAS"</h3>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                @foreach ($member->LunasProgramMobils as $program)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('program_mobil_lunas.show', ['member' => $member->id, 'program' => $program->id]) }}"
